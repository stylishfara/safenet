...
import { addContact, RELATIONSHIPS } from "@/lib/contacts"
...
export default function AddContact() {
  ...
  const handleSave = () => {
    if (!name.trim()) return
    addContact({ name: name.trim(), phone, relationship })
        ...
        <div className="h-full overflow-y-auto pb-[100px]">
          <div className="px-[20px] pt-[52px]">
            ...
            <div className="mb-[56px] flex items-center justify-between">
              ...
              <p className="text-[16px] font-medium text-[#262626]">Add Contact</p>
