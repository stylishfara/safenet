...
export default function CreateAccount() {
  ...
  return (
    /* Outer: fills viewport on mobile, centres mock frame on desktop */
    <div className="fixed inset-0 flex items-start justify-center overflow-hidden bg-[#f5f5f5] md:items-center">
      {/* Inner: full viewport on mobile, 402×874 frame on desktop */}
      <div className="relative h-full w-full overflow-hidden bg-white md:h-[874px] md:w-[402px]">

        {/* Scrollable content with bottom padding so it clears the Continue button */}
        <div className="h-full overflow-y-auto pb-[108px]">
            ...
            <div className="mt-[32px] flex flex-col gap-[24px]">
              ...
              <div className="flex flex-col gap-[4px]">
                ...
                <input
                  type="text"
                  placeholder="John"
                  className="h-[48px] w-full rounded-[10px] border border-[#e5e5e5] bg-white px-[14px] text-[14px] text-[#262626] placeholder:text-[#737373] outline-none"
                />
              </div>
              ...
              <div className="flex flex-col gap-[4px]">
                ...
                <div className="relative">
                  <input
                    ...
                    className="h-[48px] w-full rounded-[10px] border border-[#e5e5e5] bg-white px-[14px] pr-[44px] text-[14px] text-[#262626] placeholder:text-[#737373] outline-none"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-[14px] top-1/2 -translate-y-1/2 text-[#737373]"
        ...
        {/* Continue — pinned to bottom, always visible */}
